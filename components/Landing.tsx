    ...
    <div className="space-y-24 pb-20">
      ...
      <section className="relative flex flex-col items-center text-center">
        ...
        >
          ...
          >
            <img src="/logo.png" alt="Умняут" className="w-full h-full object-contain drop-shadow-xl" />
          </MotionDiv>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-game font-bold text-stone-800 leading-[1.1] mb-8 tracking-tight">
            Интеллектуальные <br/> головоломки с <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-500">умным котиком</span>
          </h1>
          <p className="text-lg md:text-xl text-stone-500 font-medium leading-relaxed mb-12 max-w-2xl mx-auto">
            Умняут — твой любознательный помощник в мире головоломок. Он создаёт уникальные кроссворды, адаптируясь под твои интересы и уровень знаний.
          </p>
          <MotionButton
        ...
        >
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="text-lg font-black text-stone-700 mb-1 uppercase tracking-tight">Тренировка ума</h4>
                <p className="text-sm text-stone-500 font-medium leading-relaxed">Решение кроссвордов создаёт новые нейронные связи и поддерживает мозг в тонусе.</p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="text-lg font-black text-stone-700 mb-1 uppercase tracking-tight">Релакс и удовольствие</h4>
                <p className="text-sm text-stone-500 font-medium leading-relaxed">Погружение в головоломки снимает стресс и дарит чувство достижения.</p>
              </div>
            </div>
          </div>
        </MotionDiv>
        ...
        >
          <div className="bg-gradient-to-br from-orange-500 to-amber-500 rounded-3xl p-10 aspect-video flex items-center justify-center shadow-2xl">
             ...
             <div className="relative z-10 text-center text-white">
                ...
                <p className="text-orange-100 text-sm font-medium opacity-90">15 минут в день повышают когнитивный тонус на 30%.</p>
             </div>
          </div>
        </MotionDiv>
      </section>
      ...
      <section className="bg-stone-800 rounded-3xl p-12 md:p-16 text-center text-white relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-lg text-stone-400 mb-10 max-w-lg mx-auto">Умняут уже ждёт тебя! Начни своё путешествие в мир знаний прямо сейчас.</p>
          <MotionButton
