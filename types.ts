...
export const AGE_GROUPS: Record<AgeGroupKey, AgeGroupConfig> = {
  ...
  teens: { min: 13, max: 17, label: '13-17 лет', description: 'Школьная программа, современные темы' },
  young: { min: 18, max: 25, label: '18-25 лет', description: 'Полный словарь, актуальный контент' },
  adult: { min: 26, max: 40, label: '26-40 лет', description: 'Академический уровень, широкий кругозор' },
  mature: { min: 41, max: 60, label: '41-60 лет', description: 'Классический подход, разнообразие тем' },
...
export const AGE_CATEGORY_MAP: Record<AgeGroupKey, string[]> = {
  kids: [
    'Животные', 'Цвета и формы', 'Еда', 'Спорт', 'Транспорт', 'Творчество',
  ],
  teens: [
    'Наука', 'История', 'География', 'Литература', 'Искусство',
    'Спорт', 'Музыка', 'Кино и культура', 'Технологии', 'Еда',
  ],
  young: [
    'Наука', 'История', 'География', 'Литература', 'Искусство',
    'Спорт', 'Музыка', 'Кино и культура', 'Технологии',
    'Экономика', 'Кулинария',
  ],
  adult: [
    'Наука', 'История', 'География', 'Литература', 'Искусство',
    'Спорт', 'Музыка', 'Кино и культура', 'Технологии',
    'Экономика', 'Право', 'Политика', 'Кулинария',
  ],
  mature: [
    'Наука', 'История', 'География', 'Литература', 'Искусство',
    'Спорт', 'Музыка', 'Кино и культура', 'Технологии',
  ...
  senior: [
    'Наука', 'История', 'География', 'Искусство',
    'Спорт', 'Музыка', 'Кино и культура', 'Кулинария',
    'Природа и садоводство',
    'Советское кино', 'Классическая литература', 'Классическая музыка',
    'История СССР/России', 'Садоводство и огородничество', 'Живопись и скульптура',
  ],
};
